...
-keepclassmembers class com.company.mobile.android.appname.datasources.card.remote.model.** {
  *;
}
-keepclassmembers class com.company.mobile.android.appname.datasources.bufferoo.cache.model.** {
  *;
}
-keepclassmembers class com.company.mobile.android.appname.datasources.card.remote.** {
  *;
}
